...
/**
 * Return true if the board is full (and the game is over)
 * @return {boolean} true if the board is full.
 */
othello.Board.prototype.isFull = function() {
  return this.numberOfLightPieces + this.numberOfDarkPieces === 64;
};
